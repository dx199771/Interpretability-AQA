...
def main(cfg):
    ...
    if cfg.get('load_from', None) and os.path.exists(cfg.load_from):
        backbone.load_state_dict(torch.load(cfg.load_from)["backbone"])
    ...
    # log and wandb
    base_logger = get_logger(f'exp/{cfg.seed}_{cfg.dataset_name}_{cfg.gym_label}_{cfg.att_loss}_{cfg.query_var}_{cfg.pe}.log', "EXP1")    
    wandb.init(project="aqa-detr-model",name=f"{cfg.seed}_{cfg.dataset_name}_{cfg.gym_label}_{cfg.att_loss}_{cfg.query_var}_{cfg.pe}")
